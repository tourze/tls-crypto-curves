 ...
 * @internal
 */
#[CoversClass(NISTP521::class)]
final class NISTP521Test extends TestCase
{
    private NISTP521 $curve;
    ...
    {
        $this->assertEquals('nistp521', $this->curve->getName());
    }
    ...
    {
        $this->assertEquals(521, $this->curve->getKeySize());
    }
    ...
    public function testGenerateKeyPairReturnsValidEcKeys(): void
    {
        ...
        $this->assertEquals('secp521r1', $privateKeyDetails['ec']['curve_name']);
        ...
        $this->assertEquals('secp521r1', $publicKeyDetails['ec']['curve_name']);
    }
    ...
    public function testDerivePublicKeySuccess(): void
    {
        ...
        $this->assertNotFalse($details, 'Failed to get public key details: ' . openssl_error_string());
        ...
        $this->assertEquals('secp521r1', $details['ec']['curve_name']);
    }
